<template>
  <div>
    ...
    <div class="word-list-container">
      <h2>Word List</h2>
      <ul class="word-list">
        <transition-group name="slideRight" tag="div" apper>
  ...
  methods: {
    addWord: function (word) {
      if (this.wordList.indexOf(word) === -1) {
        ...
        let message = {
          type: 'success',
          text: `${word} Has been added to your Word List.`
        };
        ...
        let message = {
          type: 'info',
          text: `${word} is already on your Word List.`
        };
        this.messages.push(message);
      }
    },
    removeWord: function (word) {
      this.wordList.splice(this.wordList.indexOf(word), 1);
        let message = {
            type: 'success',
            text: `${word} Has been removed from your Word List.`
        };
        this.messages.push(message);
    },
    findWords: function() {
